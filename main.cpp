...
//	std::cout << *rt.search("Georgia") << std::endl;
//
...
//	const PersonProfile* ppMD = md.GetMemberByEmail("AbFow2483@charter.net");
...
//	////Testing MatchMaker
//	//MatchMaker mm(md, at);
//	//std::vector<EmailCount> matches = mm.IdentifyRankedMatches("AbFow2483@charter.net", 6);
